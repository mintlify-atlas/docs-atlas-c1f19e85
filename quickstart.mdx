---
title: "Quickstart: Run Your First KT Testing Suite Core Test"
sidebarTitle: "Quickstart"
description: "Install KT Testing Suite Core, write your first ExtendScript test in TypeScript, build it, and execute it inside an Adobe host application."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Reporters" icon="terminal" href="/reporters/overview">
