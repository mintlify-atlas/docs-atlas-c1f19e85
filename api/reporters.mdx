---
title: "Reporter Classes and TestReporter Interface API"
sidebarTitle: "Reporters API"
description: "API reference for TestReporter interface, ConsoleReporter, JSONReporter, TestResult, and SuiteResult. Implement TestReporter to build custom output handlers."
---
...
Extends the behaviour of `ConsoleReporter` by additionally building a structured `SuiteResult` tree during the run and emitting a JSON document when `onFinished` is called.
